Shader "Unreal/MI_Sticks_Medium_01"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_Sticks_N", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(30.000000,3.500000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.100136,0.130208,0.011529,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(30.000000,15.000000,-10.000000,-25.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.100136,0.130208,0.011529,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.100000,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local1 = LWCMultiply(DERIV_BASE_VALUE(Local0), GetPrimitiveData(Parameters).WorldToLocal);
	MaterialFloat3 Local2 = (DERIV_BASE_VALUE(Local1) / ((MaterialFloat3)1024.00000000));
	MaterialFloat2 Local3 = DERIV_BASE_VALUE(Local2).rg;
	MaterialFloat3 Local4 = mul(MaterialFloat3(0.00000000,0.00000000,1.00000000), Parameters.TangentToWorld);
	MaterialFloat3 Local5 = LWCMultiplyVector(Local4, GetPrimitiveData(Parameters).WorldToLocal);
	MaterialFloat3 Local6 = abs(Local5);
	MaterialFloat3 Local7 = PositiveClampedPow(DERIV_BASE_VALUE(Local6),((MaterialFloat3)10.00000000));
	MaterialFloat Local8 = DERIV_BASE_VALUE(Local7).r;
	MaterialFloat Local9 = DERIV_BASE_VALUE(Local7).g;
	MaterialFloat Local10 = (DERIV_BASE_VALUE(Local8) + DERIV_BASE_VALUE(Local9));
	MaterialFloat Local11 = DERIV_BASE_VALUE(Local7).b;
	MaterialFloat Local12 = (DERIV_BASE_VALUE(Local10) + DERIV_BASE_VALUE(Local11));
	MaterialFloat3 Local13 = (DERIV_BASE_VALUE(Local7) / ((MaterialFloat3)DERIV_BASE_VALUE(Local12)));
	MaterialFloat3 Local14 = lerp(MaterialFloat3(MaterialFloat2((0.00000000 - 512.00000000),(0.00000000 - 512.00000000)),(0.00000000 - 512.00000000)),((MaterialFloat3)(512.00000000 + 1.00000000)),DERIV_BASE_VALUE(Local13));
	MaterialFloat3 Local15 = saturate(DERIV_BASE_VALUE(Local14));
	MaterialFloat Local16 = DERIV_BASE_VALUE(Local15).b;
	MaterialFloat2 Local17 = (DERIV_BASE_VALUE(Local3) * ((MaterialFloat2)DERIV_BASE_VALUE(Local16)));
	MaterialFloat2 Local18 = DERIV_BASE_VALUE(Local2).gb;
	MaterialFloat Local19 = DERIV_BASE_VALUE(Local15).r;
	MaterialFloat2 Local20 = (DERIV_BASE_VALUE(Local18) * ((MaterialFloat2)DERIV_BASE_VALUE(Local19)));
	MaterialFloat2 Local21 = DERIV_BASE_VALUE(Local2).rb;
	MaterialFloat Local22 = DERIV_BASE_VALUE(Local15).g;
	MaterialFloat2 Local23 = (DERIV_BASE_VALUE(Local21) * ((MaterialFloat2)DERIV_BASE_VALUE(Local22)));
	MaterialFloat2 Local24 = (DERIV_BASE_VALUE(Local20) + DERIV_BASE_VALUE(Local23));
	MaterialFloat2 Local25 = (DERIV_BASE_VALUE(Local17) + DERIV_BASE_VALUE(Local24));
	MaterialFloat2 Local26 = (DERIV_BASE_VALUE(Local25) * ((MaterialFloat2)Material.PreshaderBuffer[1].x));
	MaterialFloat Local27 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local26), 1);
	MaterialFloat4 Local28 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,DERIV_BASE_VALUE(Local26),View.MaterialTextureMipBias));
	MaterialFloat Local29 = MaterialStoreTexSample(Parameters, Local28, 1);
	MaterialFloat3 Local30 = lerp(Local28.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),Material.PreshaderBuffer[1].y);
	...
	MaterialFloat3 Local31 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].z);
	MaterialFloat2 Local32 = Parameters.TexCoords[0].xy;
	MaterialFloat Local33 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local32), 2);
	MaterialFloat4 Local34 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local32),View.MaterialTextureMipBias));
	MaterialFloat Local35 = MaterialStoreTexSample(Parameters, Local34, 2);
	MaterialFloat Local36 = dot(WorldNormalCopy,normalize(MaterialFloat3(0.00000000,1.00000000,0.00000000)));
	MaterialFloat Local37 = (Local36 * 0.50000000);
	MaterialFloat Local38 = (Local37 + 0.50000000);
	MaterialFloat Local39 = (Local38 * Material.PreshaderBuffer[4].x);
	MaterialFloat Local40 = (Local39 + Material.PreshaderBuffer[4].w);
	MaterialFloat Local41 = saturate(Local40);
	MaterialFloat3 Local42 = lerp(Local34.rgb,Material.PreshaderBuffer[5].xyz,Local41);
	MaterialFloat3 Local43 = (((MaterialFloat3)Material.PreshaderBuffer[5].w) * Local42);
	MaterialFloat Local44 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local32), 0);
	MaterialFloat4 Local45 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local32),View.MaterialTextureMipBias));
	MaterialFloat Local46 = MaterialStoreTexSample(Parameters, Local45, 0);
	MaterialFloat Local47 = (Material.PreshaderBuffer[6].x * Local45.g);
