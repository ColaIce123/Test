Shader "Unreal/MI_Mushroom_05_Night"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.950000,0.050000,1.050000,-0.050000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,1.000000,1.000000,5.000000);//(Unknown)
