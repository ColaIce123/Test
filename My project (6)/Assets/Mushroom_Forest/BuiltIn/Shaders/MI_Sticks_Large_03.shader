Shader "Unreal/MI_Sticks_Large_03"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,-10.000000,-10.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.100136,0.130208,0.011529,10.000000);//(Unknown)
