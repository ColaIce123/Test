Shader "Unreal/MI_Mushroom_11_Night"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.000000,0.406250,0.375687,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(2.000000,0.850000,1.000000,0.000000);//(Unknown)
