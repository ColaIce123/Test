Shader "Unreal/MI_Mushroom_09_Night"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.000000,0.406250,0.375687,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.406250,0.375687,10.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(3.000000,0.850000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.500000,20.000000,0.000000,0.000000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local6 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local7 = MaterialStoreTexSample(Parameters, Local6, 3);
	MaterialFloat Local8 = lerp(Material.PreshaderBuffer[3].w,Material.PreshaderBuffer[3].z,Local6.rgb.x);
	MaterialFloat Local9 = saturate(Local8);
	MaterialFloat3 Local10 = lerp(((MaterialFloat3)0.00000000),Material.PreshaderBuffer[4].xyz,Local9.r);
	MaterialFloat3 Local11 = (Local10 * ((MaterialFloat3)Material.PreshaderBuffer[4].w));
	MaterialFloat3 Local12 = lerp(Local11,Material.PreshaderBuffer[5].yzw,Material.PreshaderBuffer[5].x);
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 2);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 2);
	MaterialFloat3 Local16 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000)),Material.PreshaderBuffer[6].z),((MaterialFloat3)0.00000000),Local14.rgb);
	MaterialFloat3 Local17 = (Local16 + Local14.rgb);
	MaterialFloat Local18 = dot(Local17,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local19 = lerp(Local17,((MaterialFloat3)Local18),Material.PreshaderBuffer[6].w);
	MaterialFloat3 Local20 = (Local19 * ((MaterialFloat3)Material.PreshaderBuffer[7].x));
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local22 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 0);
	MaterialFloat Local24 = (Material.PreshaderBuffer[7].y * Local22.g);
	MaterialFloat3 Local25 = (Local19 * ((MaterialFloat3)Material.PreshaderBuffer[7].z));
	MaterialFloat Local26 = (Local22.r * Material.PreshaderBuffer[8].x);
	MaterialFloat2 Local27 = GetPixelPosition(Parameters);
	MaterialFloat Local28 = View.TemporalAAParams.x;
	MaterialFloat2 Local29 = (Local27 + MaterialFloat2(Local28,Local28));
	MaterialFloat Local30 = CustomExpression0(Parameters,Local29);
	MaterialFloat2 Local31 = (Local27 / MaterialFloat2(64.00000000,64.00000000));
	MaterialFloat Local32 = MaterialStoreTexCoordScale(Parameters, Local31, 4);
	MaterialFloat4 Local33 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,Local31,View.MaterialTextureMipBias));
	MaterialFloat Local34 = MaterialStoreTexSample(Parameters, Local33, 4);
	MaterialFloat Local35 = (Local33.r * 1.00000000);
	MaterialFloat Local36 = (Local30 + Local35);
	MaterialFloat Local37 = (Local36 / 6.00000000);
	MaterialFloat Local38 = (0.50000000 + Local37);
	MaterialFloat Local39 = (Local38 + -0.50000000);
	MaterialFloat Local40 = (Local39 * Material.PreshaderBuffer[8].y);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local25,Material.PreshaderBuffer[7].w);
	PixelMaterialInputs.AmbientOcclusion = Local26;
	PixelMaterialInputs.Refraction = 0;
	PixelMaterialInputs.PixelDepthOffset = Local40;
