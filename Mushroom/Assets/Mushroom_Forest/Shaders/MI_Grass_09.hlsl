...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(2.000000,0.300000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(0.062204,0.182292,-9.945089,0.100000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.100000,1.000000,0.000000,0.500000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local16 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local26 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_3,sampler_Material_Texture2D_3,Local24,View.MaterialTextureMipBias));
