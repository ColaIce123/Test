...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,0.000000,0.000000,-0.150000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,0.000000,1.000000,3.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(3.000000,1.000000,30.000000,0.033333);//(Unknown)
	...
	Material.PreshaderBuffer[12] = float4(1.000000,0.000000,-0.150000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.000000,-0.150000,0.000000,-0.150000);//(Unknown)
	...
	Material.PreshaderBuffer[16] = float4(0.606345,0.755208,0.593940,0.350000);//(Unknown)
	Material.PreshaderBuffer[17] = float4(0.755208,0.606345,0.606345,0.755208);//(Unknown)
	Material.PreshaderBuffer[18] = float4(0.606345,0.755208,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[21] = float4(1.000000,0.000000,0.350000,0.593940);//(Unknown)
	Material.PreshaderBuffer[22] = float4(0.593940,0.350000,0.593940,0.350000);//(Unknown)
	Material.PreshaderBuffer[23] = float4(-2.000000,-1.000000,-1.000000,-2.000000);//(Unknown)
	Material.PreshaderBuffer[24] = float4(1.000000,0.000000,2.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[41] = float4(-2.000000,2.000000,3.000000,2.000000);//(Unknown)
	...
	Material.PreshaderBuffer[49] = float4(0.000000,0.000000,0.000000,0.007843);//(Unknown)
	Material.PreshaderBuffer[50] = float4(0.007843,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[51] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[52] = float4(0.020000,0.000000,0.000000,0.027451);//(Unknown)
	Material.PreshaderBuffer[53] = float4(0.027451,0.020000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[54] = float4(0.000549,0.000000,0.000000,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local21 = UnpackNormalMap(Texture2DSample(Material_Texture2D_0,GetMaterialSharedSampler(sampler_Material_Texture2D_0,View_MaterialTextureBilinearWrapedSampler),Local19));
	...
	MaterialFloat4 Local30 = UnpackNormalMap(Texture2DSample(Material_Texture2D_1,GetMaterialSharedSampler(sampler_Material_Texture2D_1,View_MaterialTextureBilinearWrapedSampler),Local28));
	...
	MaterialFloat4 Local44 = UnpackNormalMap(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(sampler_Material_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local42));
	...
	MaterialFloat4 Local53 = UnpackNormalMap(Texture2DSample(Material_Texture2D_3,GetMaterialSharedSampler(sampler_Material_Texture2D_3,View_MaterialTextureBilinearWrapedSampler),Local51));
	...
	MaterialFloat4 Local76 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_4,GetMaterialSharedSampler(sampler_Material_Texture2D_4,View_MaterialTextureBilinearWrapedSampler),Local74));
	...
	MaterialFloat4 Local85 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_5,GetMaterialSharedSampler(sampler_Material_Texture2D_5,View_MaterialTextureBilinearWrapedSampler),Local83));
	...
	MaterialFloat4 Local96 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_6,GetMaterialSharedSampler(sampler_Material_Texture2D_6,View_MaterialTextureBilinearWrapedSampler),Local94));
	...
	MaterialFloat4 Local104 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_7,GetMaterialSharedSampler(sampler_Material_Texture2D_7,View_MaterialTextureBilinearWrapedSampler),Local102));
